...
momiji = User.find_or_create_by!(email: "momiji@example.com") do |user|
  ...
  user.profile_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-user1.jpg"), filename: "sample-user1.jpg")
end

PostHobby.find_or_create_by!(title: "パウンドケーキ") do |post_hobby|
  post_hobby.post_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-post1.jpg"), filename: "sample-post1.jpg")
...
PostHobby.find_or_create_by!(title: "星空") do |post_hobby|
  post_hobby.post_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-post3.jpg"), filename: "sample-post3.jpg")
...
sakura = User.find_or_create_by!(email: "sakura@example.com") do |user|
  ...
  user.password = "password"
  user.profile_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-user2.jpg"), filename: "sample-user2.jpg")
end

PostHobby.find_or_create_by!(title: "料理") do |post_hobby|
  post_hobby.post_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-post2.jpg"), filename: "sample-post2.jpg")
...
Group.find_or_create_by!(group_name: "料理研究会") do |group|
  group.group_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-group1.jpg"), filename: "sample-group1.jpg")
...
Group.find_or_create_by!(group_name: "写真に収めたい！") do |group|
  group.group_image = ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/assets/images/sample-group2.jpg"), filename: "sample-group2.jpg")
